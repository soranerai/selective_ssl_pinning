...
class TrustConfigStore(context: Context) {
    private val root = context.applicationContext.createDeviceProtectedStorageContext()
    ...
    @Synchronized fun read(): ModuleConfig {
        ...
        return ModuleConfig(enabledFile.readTextOrNull()?.trim() == "1", rules, certificates, loggingFile.readTextOrNull()?.trim() == "1")
    }
